import svgPaths from "./svg-ih2l7jyrdn";
...
function Container() {
  return (
    <div className="absolute content-stretch flex flex-col h-[5.491px] items-start left-[12px] top-[4.3px] w-[4.321px]" data-name="Container">
      <Icon />
    </div>
  );
}
