import svgPaths from "./svg-bbf9puob7g";
import { imgGroup } from "./svg-6srdf";
  ...
  return (
    <div className="absolute inset-[12.5%_10.67%_13.58%_12.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3px_-3px] mask-size-[24px_24px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.4391 17.74">
        <g id="Group">
          <g id="Vector">
            <path d={svgPaths.p23c64700} fill="var(--fill-0, black)" />
            <path d={svgPaths.p3836d900} fill="var(--fill-0, black)" />
          </g>
          <path d={svgPaths.p1d1e1200} fill="var(--fill-0, black)" id="Vector_2" />
          <path d={svgPaths.pa8bed40} fill="var(--fill-0, black)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
